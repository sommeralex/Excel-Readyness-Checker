...
STRINGS: dict[str, str] = {
    ...
    "engine.unnamed_source": "unbenannte-Datei.xlsx",
    "engine.bad_source": "Quelle muss ein Dateipfad oder ein file-like Objekt sein, nicht {type}.",
    "engine.unseekable_source": "Der Puffer lässt sich nicht positionieren – bitte den vollständigen Inhalt als BytesIO übergeben.",
