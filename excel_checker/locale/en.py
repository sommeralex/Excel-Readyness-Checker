...
STRINGS: dict[str, str] = {
    ...
    "engine.unnamed_source": "unnamed-file.xlsx",
    "engine.bad_source": "Source must be a file path or a file-like object, not {type}.",
    "engine.unseekable_source": "Buffer is not seekable – pass the full content as BytesIO.",
